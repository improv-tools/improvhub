      ...
      <Card>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            <GhostButton onClick={() => setTab("profile")}>Profile</GhostButton>
        ...
        {tab === "home" && (
          <div>
            ...
            <p style={{ opacity: 0.8, marginTop: 8 }}>
              Use the <strong>Profile</strong> button (top right) to update your name, or the{" "}
              <strong>Teams</strong> tab to create/join teams.
            </p>
          </div>
        )}
